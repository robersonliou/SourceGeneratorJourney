...
namespace SourceGeneratorLib.Extensions
{
    ...
    {
        public static IEnumerable<(string propertyType, string propertyName, PropertyDeclarationSyntax propertySyntax)> 
            GetProperties(this ClassDeclarationSyntax classSyntax, SemanticModel semanticModel)
        {
